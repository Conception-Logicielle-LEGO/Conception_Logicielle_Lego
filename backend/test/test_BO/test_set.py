...
def test_set_init():
    s = Set(set_num="75192-1", name="Millennium Falcon", year=2017, theme_id=158, num_parts=7541)
...
def test_set_init_with_img():
    s = Set(set_num="75192-1", name="Falcon", year=2017, theme_id=158, num_parts=100, img_url="http://img")
...
def test_set_from_dict():
    data = {"set_num": "1234-1", "name": "Castle", "year": 2000, "theme_id": 1, "num_parts": 500}
...
def test_set_to_dict():
    s = Set(set_num="1234-1", name="Castle", year=2000, theme_id=1, num_parts=500, img_url="http://img")
    d = s.to_dict()
    assert d == {
        "set_num": "1234-1",
        "name": "Castle",
